...
exports.exo_cahier_3 = void 0;
const exo_cahier_3 = () => {
    let min = 0;
    let max = 0;
    console.log("start");
    nombreAleatoire();
    // nombreAleatoireEntre()
    function nombreAleatoire() {
        const nbr_alea = Math.floor(Math.random() * 101);
        console.log(nbr_alea);
    }
    ...
    // }
    // let tableau_nbr: number[] = []
    // nbr_alea()
    // console.log(tableau_nbr);
    // function nbr_alea() {
    //     for (let i = 0; i < 10; i++) {
...
exports.exo_cahier_3 = exo_cahier_3;
